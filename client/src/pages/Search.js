...
import ResultContainer from "../components/ResultsContainer.js";
...
class Search extends Component {
     ...
     render() {
          return <main>
               ...
               {(this.state.bookData.length > 0) ? <ResultContainer bookData={this.state.bookData} path={this.props.match.path}/> : null}
          </main>
     }
}
