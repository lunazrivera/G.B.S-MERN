...
class BookResult extends React.Component {
     ...
     render() {
          return <div className="bookResult" id={(this.props.id) ? this.props.id: null} style={{display: this.stateldelted ? "none" : "block"}}>
               <div className="row">
               ...
               <div className="row">
                    {(this.props.img) ? <img src={(this.props.img.smallThumbnail) ? this.props.img.smallThumbnail : (this.props.img.thumbnail) ? this.props.img.thumbnail : ""} alt="book cover"/> : null}
                    <p>{(this.props.description) ? this.props.img.description : "N/A"}</p>
               </div>
